...
export const seedAppointments: Appointment[] = [
  {
    id: "appointment-1",
    title: "Trial session with Nisha Yadav",
    ...
    leadId: "lead-2",
    trainerId: "trainer-2",
    notes: "Focus on beginner strength assessment and student plan options.",
    createdAt: dateOffset(-2),
    updatedAt: dateOffset(-1),
  },
  {
    id: "appointment-2",
    title: "Annual renewal discussion",
    ...
    status: "scheduled",
    memberId: "member-014",
    notes: "Discuss annual plan renewal before membership expiry.",
    createdAt: dateOffset(-1),
    updatedAt: dateOffset(-1),
  },
  {
    ...
    memberId: "member-006",
    trainerId: "trainer-2",
    notes: "Review beginner training split and nutrition questions.",
    createdAt: dateOffset(-1),
    updatedAt: dateOffset(-1),
  },
  {
    ...
    memberId: "member-001",
    trainerId: "trainer-1",
    notes: "Baseline strength assessment completed.",
    createdAt: dateOffset(-4),
    updatedAt: dateOffset(-1),
  },
  {
    id: "appointment-5",
    title: "Trial session with Dhruv Goyal",
    appointmentDate: dateOffset(1),
    startTime: "19:30",
    endTime: "20:30",
    type: "trial_session",
    ...
    leadId: "lead-9",
    trainerId: "trainer-5",
    notes: "Trial booked after Google enquiry.",
    createdAt: dateOffset(-2),
    updatedAt: dateOffset(-1),
  },
  {
    id: "appointment-6",
    title: "Membership plan enquiry",
    ...
    status: "no_show",
    leadId: "lead-7",
    notes: "Lead did not arrive for the planned walk-in discussion.",
    createdAt: dateOffset(-5),
